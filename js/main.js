...
class App {
    ...
    async initializeServices() {
        ...
        this.services.accessibility = AccessibilityService;
        ...
        this.services.search = SearchService;
    ...
    onSearchResultsDisplayed(detail) {
        ...
        // 更新地圖（如果需要）
        if (detail.toilets.length > 0 && MapService.isInitialized) {
            // 地圖更新邏輯
        }
    }
    ...
    onWindowResize() {
        // 調整地圖大小
        if (MapService.isInitialized && MapService.map) {
            setTimeout(() => {
